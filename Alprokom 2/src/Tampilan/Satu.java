...
public class Satu extends javax.swing.JFrame {
    ...
    private int score;
    private static final String CORRECT_ANSWER = "batagor"; 
    private boolean answeredCorrectly = false;
    private static final String[] HINTS = {
        "Terbuat dari tahu dan aci", 
        "Biasanya disajikan dengan bumbu kacang",
        "Singkatan dari 'bakso tahu goreng'"
    };
    ...
    public Satu() {
        ...
        initComponents();
        SkorTxt.setText(String.valueOf(progress.getTotalScore()));
    ...
    private void completeLevel() {
        if (answeredCorrectly) {
            progress.completeLevel(0, remainingLives); 
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(561, 360));

        jPanel1.setBackground(new java.awt.Color(204, 255, 255));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Gambar1.setBackground(new java.awt.Color(204, 255, 204));
        Gambar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/4.png"))); // NOI18N
        jPanel1.add(Gambar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 250, 250));
        ...
        jPanel1.add(CekBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 180, 70, 33));

        jLabel1.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        jLabel1.setText("Skor");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 240, -1, -1));
        ...
        jPanel1.add(SkorTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 240, 90, 30));
        ...
        jPanel1.add(ExitBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, -1, 35));
        ...
        jPanel1.add(NextBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 280, -1, 35));
        ...
        jPanel1.add(BenarSalahTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 90, 33));

        InfoTxt.setBackground(new java.awt.Color(176, 208, 235));
        InfoTxt.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        InfoTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                InfoTxtActionPerformed(evt);
            }
        });
        jPanel1.add(InfoTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 50, 260, 60));
        ...
        jPanel1.add(HintBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 210, 60, 35));
    ...
    private void updateScore() {
        GameProgress.getInstance().getTotalScore();
