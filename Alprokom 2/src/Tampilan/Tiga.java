...
public class Tiga extends javax.swing.JFrame {
    ...
    private int score;
    private static final String CORRECT_ANSWER = "yoshinoya"; 
    private boolean answeredCorrectly = false;
    private static final String[] HINTS = {
        "Restoran cepat saji asal Jepang",
        "Nama restoran dimulai dengan 'Y'",
        "Makanan utamanya adalah bowl dengan daging dan nasi"
    };
    ...
    private void completeLevel() {
        if (answeredCorrectly) {
            progress.completeLevel(2, remainingLives);
    ...
    private void initComponents() {
        ...
        Gambar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/2.png"))); // NOI18N
