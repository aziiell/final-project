...
public class Empat extends javax.swing.JFrame {
    ...
    private int score;
    private static final String CORRECT_ANSWER = "ayam kampung"; 
    private boolean answeredCorrectly = false;
    private static final String[] HINTS = {
        "Dagingnya lebih alot dibanding ayam potong biasa",
        "Sering dijadikan bahan utama soto dan opor",
        "Disebut juga 'ayam bukan ras' atau 'ayam buras'"
    };
    ...
    private void completeLevel() {
        if (answeredCorrectly) {
            progress.completeLevel(3, remainingLives);
    ...
    private void initComponents() {
        ...
        Gambar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/5.png"))); // NOI18N
